...
const TEST_NAMES: &[&str] = &[
    ...
    "paste_multiframe_layout_into_single_frame",
    "paste_single_frame_over_multiframe_region",
    "paste_layout_preserves_target_outline_and_outside_frames",
    "layout_clipboard_rejects_nonrectangular_selection",
    "layout_clipboard_rejects_nonrectangular_target",
    "hover_detects_center_divider",
    "save_and_load_roundtrip",
    "load_state_rejects_future_schema_version",
    "cover_pages_mode_splits_cover_into_front_and_back",
    "cover_pages_mode_merges_back_into_wraparound",
    "cover_pages_mode_moves_cover_text_to_pages",
    "cover_pages_back_cover_stays_last_when_adding_spreads",
    "cover_pages_endpapers_use_content_spreads",
    "cover_pages_export_jobs_front_first_back_last",
    "cover_pages_normalized_on_load",
    // grid_resolver tests
...
pub fn wasm_test_run(name: &str) {
    ...
    match name {
        ...
        "divider_gap_allows_negative"                        => et::divider_gap_allows_negative(),
        ...
        "paste_multiframe_layout_into_single_frame"         => et::paste_multiframe_layout_into_single_frame(),
        "paste_single_frame_over_multiframe_region"         => et::paste_single_frame_over_multiframe_region(),
        "paste_layout_preserves_target_outline_and_outside_frames" => et::paste_layout_preserves_target_outline_and_outside_frames(),
        "layout_clipboard_rejects_nonrectangular_selection" => et::layout_clipboard_rejects_nonrectangular_selection(),
        "layout_clipboard_rejects_nonrectangular_target" => et::layout_clipboard_rejects_nonrectangular_target(),
        "hover_detects_center_divider" => et::hover_detects_center_divider(),
        ...
        "cover_pages_mode_splits_cover_into_front_and_back" => et::cover_pages_mode_splits_cover_into_front_and_back(),
        "cover_pages_mode_merges_back_into_wraparound"      => et::cover_pages_mode_merges_back_into_wraparound(),
        "cover_pages_mode_moves_cover_text_to_pages"        => et::cover_pages_mode_moves_cover_text_to_pages(),
        "cover_pages_back_cover_stays_last_when_adding_spreads" => et::cover_pages_back_cover_stays_last_when_adding_spreads(),
        "cover_pages_endpapers_use_content_spreads"         => et::cover_pages_endpapers_use_content_spreads(),
        "cover_pages_export_jobs_front_first_back_last"     => et::cover_pages_export_jobs_front_first_back_last(),
        "cover_pages_normalized_on_load"                    => et::cover_pages_normalized_on_load(),
