...
export const idleMode: InteractionMode = {
  onMouseDown(e, ctx) {
    ...
    function handleEdgeHit(): void {
      ...
      snapshot();
      setMode(edgeLiveDragMode, { edge, axis, newIsFirst, spawned: false, segmentId: NULL_ID } as EdgeLiveDragState);
      e.preventDefault();
    }
    ...
    if (e.altKey && handleImageSwapHit()) return;
